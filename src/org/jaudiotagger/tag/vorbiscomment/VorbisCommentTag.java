...
public class VorbisCommentTag extends AbstractTag
{
	...
	/**
	 * Delete a field at the specified index with this key
	 * @param genericKey
	 * @param index
	 * @throws KeyNotFoundException 
	 */
	@Override
	public void deleteFieldAt(FieldKey genericKey, int index) throws KeyNotFoundException
	{
		//Same as deleteField(FieldKey genericKey)
		if (genericKey == null)
        {
            throw new KeyNotFoundException();
        }
        VorbisCommentFieldKey vorbisCommentFieldKey = tagFieldToOggField.get(genericKey);
        deleteFieldAt(vorbisCommentFieldKey, index);
	}
	
	/**
	 * Delete a field at the specified index with this vorbisCommentKey
	 * @param vorbisCommentFieldKey
	 * @param index
	 * @throws KeyNotFoundException 
	 */
	public void deleteFieldAt(VorbisCommentFieldKey vorbisCommentFieldKey, int index) throws KeyNotFoundException
	{
		if (vorbisCommentFieldKey == null)
        {
            throw new KeyNotFoundException();
        }
        super.deleteFieldAt(vorbisCommentFieldKey.getFieldName(), index);
	}
	...
	public void setFieldAt(String vorbisCommentKey, String value, int index) throws KeyNotFoundException, FieldDataInvalidException {
		TagField tagfield = createField(vorbisCommentKey, value);
		setFieldAt(tagfield, index);
	}
	
	@Override
	public void setFieldAt(FieldKey genericKey, String value, int index) throws KeyNotFoundException, FieldDataInvalidException {
