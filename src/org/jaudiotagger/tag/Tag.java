...
public interface Tag {
	...
	/**
	 * For formats that support multiple values, sets the value at a specific point
	 * 
	 * @param genericKey
	 * @param value
	 * @param index
	...
	/**
	 * Delete the field at the specified index with this key
	 * Multiple field values is supported by Vorbis/ID3v24
	 * 
	 * @param key
	 * @param index
	 */
	public void deleteFieldAt(FieldKey key, int index) throws KeyNotFoundException;
	
	/**
	 * Delete the field at the specified index with this Flac (Vorbis Comment) id
	 * 
	 * @param key
	 * @param index 
	 */
	public void deleteFieldAt(String key, int index) throws KeyNotFoundException;
