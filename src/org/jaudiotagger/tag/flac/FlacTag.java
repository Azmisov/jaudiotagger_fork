...
public class FlacTag implements Tag
{
	...
	public void setFieldAt(TagField field, int index) throws FieldDataInvalidException{
		if (field instanceof MetadataBlockDataPicture)
            setField(field);
		else tag.setFieldAt(field, index);
	}
	...
	public void deleteFieldAt(FieldKey fieldKey, int index) throws KeyNotFoundException
	{
        ...
        {
			tag.deleteFieldAt(fieldKey, index);
		}
	}
	
	public void deleteFieldAt(String id, int index) throws KeyNotFoundException
	{
		//same as deleteField(string)
		if (id.equals(FieldKey.COVER_ART.name()))
        {
			images.clear();
        }
